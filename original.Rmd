...
tweets <- rio::import(here::here("equity.csv"), encoding="UTF-8")
...
tweet_bigrams_nostop <- tweet_unigrams_nostop %>%
...
ggplot(tweet_topic_document, aes(gamma)) +
  geom_histogram() +
  scale_y_log10() +
  labs(title = "Distribution of Probabilities across all Topics",
...
ggplot(tweet_topic_document, aes(gamma, fill = as.factor(topic))) +
  ...
  scale_y_log10() +
  labs(title = "Distribution of Probabilities across each Topic",
       y = "Number of documents", x = expression(gamma))
```
